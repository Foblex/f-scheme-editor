// Connected Graph
// ----------------------------------------------------------------------
// Description: Graph where there is a path between every pair of vertices.
// ----------------------------------------------------------------------
// Complexity:
// Adjaency list:
...
// ----------------------------------------------------------------------
// When to use: Useful when you need to represent relationships between objects where every object is connected to every other object, for example in social networks or maps.

// Example code:
export class ConnectedGraph<T> {
