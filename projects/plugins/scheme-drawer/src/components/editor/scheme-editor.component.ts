...
import { map, merge, Subject, Subscription, take } from 'rxjs';
import {
  ESchemeBackground,
  ESchemeConnectionMarker,
...
import { ConnectionTextStyleDirective } from './connection-text-style.directive';
...
export class SchemeEditorComponent implements OnInit, OnDestroy {
  ...
  public eSchemeConnectionMarker = ESchemeConnectionMarker;
  ...
  private subscribeReloadEvents(): Subscription {
    return merge(
      this.hasChanges$,
      EditorContainerEvents.reloadComponentEvent,
